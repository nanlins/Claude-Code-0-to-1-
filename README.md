...
# 2. 构建并启动完整栈（App + Redis + PostgreSQL+pgvector）
...
- **Docker 集成**：Dockerfile 多阶段构建 + docker-compose 编排（App+Redis+PostgreSQL）+ DockerSandbox 容器沙箱
